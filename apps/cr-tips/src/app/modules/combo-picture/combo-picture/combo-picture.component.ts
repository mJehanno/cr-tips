...
export class ComboPictureComponent implements OnInit{
  ...
  limit = {
    ...
    sorcerer: [{value: 3, effect: 'Reduces ennemy magic resistance by 20'},{value: 6, effect: 'Reduce ennemy magic resistance by 60'}],
    ...
    hunter: [{value: 3, effect: 'Increases attack damage of ally hunters by 25%'},
      {value: 6, effect: 'Increases attack damage of ally hunters by 60%'}],
